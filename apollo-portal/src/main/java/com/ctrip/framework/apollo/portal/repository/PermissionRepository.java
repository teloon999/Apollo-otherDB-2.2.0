...
public interface PermissionRepository extends PagingAndSortingRepository<Permission, Long> {
  ...
  @Modifying
  @Query(value = "UPDATE \"Permission\" SET \"IsDeleted\" = 1, \"DeletedAt\" = EXTRACT(EPOCH FROM NOW())*1000, \"DataChange_LastModifiedBy\" = ?2 WHERE \"Id\" in ?1 and \"IsDeleted\" = 0", nativeQuery = true)
