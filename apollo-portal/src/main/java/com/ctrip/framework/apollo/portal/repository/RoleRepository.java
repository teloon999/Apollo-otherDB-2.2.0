...
public interface RoleRepository extends PagingAndSortingRepository<Role, Long> {
  ...
  @Modifying
  @Query(value = "UPDATE \"Role\" SET \"IsDeleted\" = 1, \"DeletedAt\" = EXTRACT(EPOCH FROM NOW())*1000, \"DataChange_LastModifiedBy\" = ?2 WHERE \"Id\" in ?1 and \"IsDeleted\" = 0", nativeQuery = true)
