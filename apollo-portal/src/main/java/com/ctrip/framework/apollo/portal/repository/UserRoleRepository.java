...
public interface UserRoleRepository extends PagingAndSortingRepository<UserRole, Long> {
  ...
  @Modifying
  @Query(value = "UPDATE \"UserRole\" SET \"IsDeleted\" = 1, \"DeletedAt\" = EXTRACT(EPOCH FROM NOW())*1000, \"DataChange_LastModifiedBy\" = ?2 WHERE \"RoleId\" in ?1 and \"IsDeleted\" = 0", nativeQuery = true)
