...
public interface ItemRepository extends PagingAndSortingRepository<Item, Long> {
  ...
  @Modifying
  @Query(value = "update \"Item\" set \"IsDeleted\" = 1, \"DeletedAt\" = ROUND(EXTRACT(EPOCH FROM NOW())*1000), \"DataChange_LastModifiedBy\" = ?2 where \"NamespaceId\" = ?1 and \"IsDeleted\" = 0", nativeQuery = true)
  int batchDeleteByNamespaceId(long namespaceId, String operator);
